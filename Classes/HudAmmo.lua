...
function HUDAmmo:refresh()
    self._weapon_ammo_details = {PDTHHud.textures:get_bullet_details(self._weapon_details.id, self._weapon_details.sub_category or self._weapon_details.category)}
