...
function HUDAmmoHandler:update_ammo_icons(previous_current_clip)
    ...
    if PDTHHud.Options:GetValue("HUD/BulletGradualColour") and previous_current_clip then
...
function HUDAmmoHandler:refresh_ammo_colour(start, end_point)
    ...
    local gradual = PDTHHud.Options:GetValue("HUD/BulletGradualColour")
    ...
    local ammo_colour = PDTHHud.constants.main_ammo_colour
...
function HUDAmmoHandler:refresh()
    if PDTHHud.Options:GetValue("HUD/Bullet") == 1 then
...
function HUDAmmoHandler:create_ammo_icons()
    ...
    local icon, details = unpack(self._parent._weapon_ammo_details)
    local dyn_bullets = PDTHHud.Options:GetValue("HUD/DynamicBullets")
    self._max_ammo = (dyn_bullets and (details.dyn_max or const.main_ammo_max_dyn) or (details.max or const.main_ammo_max)) / PDTHHud.Options:GetValue("HUD/Scale")
