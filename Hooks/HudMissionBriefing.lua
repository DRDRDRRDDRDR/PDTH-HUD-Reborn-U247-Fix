Hooks:PostHook(HUDMissionBriefing, "init", function(self, hud, workspace)	    
...
Hooks:PostHook(HUDMissionBriefing, "set_player_slot", function(self, nr, params)
...
Hooks:PostHook(HUDMissionBriefing, "set_slot_ready", function(self, peer, peer_id)