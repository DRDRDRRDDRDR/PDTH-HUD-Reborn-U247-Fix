...
function MenuItemChallenge:setup_gui( node, row_item )
	...
	do --Main Item Panel
		...
		row_item.challenge_name:set_font(Idstring(tweak_data.menu.small_font))
	...
	do --Progress Panel
		...
		local bg = row_item.progress_panel:bitmap({
			...
			texture_rect = PDTHHud.constants.interaction_bg_texture_rect,
		...
		row_item.progress_bitmap = row_item.progress_panel:bitmap({
			...
			texture_rect = PDTHHud.constants.interaction_main_texture_rect,
			w = row_item.progress_panel:w(),
			h = row_item.progress_panel:h()
		})
		...
		if challenge_data.count then
			...
			local rect = PDTHHud.constants.interaction_main_texture_rect
